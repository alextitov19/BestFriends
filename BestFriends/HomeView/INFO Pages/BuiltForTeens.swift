...
//
                    ...
                    VStack {
                        ...
                        .background(mood == 6 ? ColorManager .purple2 : ColorManager .purple2)
                        .cornerRadius(7)
                        .shadow(color: Color(#colorLiteral(red: 0.2067186236, green: 0.2054963708, blue: 0.2076624334, alpha: 1)), radius: 2, x: 0, y: 2)
...
//
    ...
    func shareButtonTapped() {
        ...
        for id in selectedFriends {
            for f in friends {
                if f.id == id {
                    RestApi.instance.sendPushNotification(title: "BestFriends", body: " \(user.firstName) wants you to join them in FriendGroup Room. ", APNToken: f.APNToken)
                }
            }
        }
