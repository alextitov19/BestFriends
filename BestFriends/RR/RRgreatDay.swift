...
//  BestFriends
//
//  Created by Social Tech on 1/6/24.
//
                    ...
                    VStack {
                        ...
                        Button(action: {
                            ...
                            Image("iconShare")
                                ...
                                .alert("We just sent a notification to your friends about your great day", isPresented: $showingAlert) {
...
//    **********************************************
    func shareButtonTapped() {
        ...
        for id in selectedFriends {
            for f in friends {
                if f.id == id {
                    RestApi.instance.sendPushNotification(title: "BestFriends", body: "yep yep! ...  \(user.firstName) is having a great day. Yes, yes, yes!!!", APNToken: f.APNToken)
                    
                    //MARK: The code below creates an in-app notification for your friend (f.id)
                    //MARK: DO NOT CHANGE THE TEXT OF THE NOTIFICATION, otherwise the code to take the user to a diffrent page will not work. Once you set it, do not change it.
                    RestApi.instance.createInAppNotification(ian: InAppNotification(user: f.id, sender: user.id, text: "I'm having a great day", createdOn: Int64(Date().timeIntervalSince1970))).then({ response in
                        print("Create a great day notification response code: ", response)
                    })
