...
//  BestFriends
//
//  Created by Social Tech on 1/13/24.
//
...
//        let arr = [user.id, friend.id]
        ...
        customMessage = "Want to talk? " + user.firstName + " : " + customMessage;
...
//                                .blinking(duration: 5.0)
                            ...
                            VStack {
                                ...
                                Text("I understand you may want some")
                                    .font(.system(size: 13))
                                    .italic()
                                    .fontWeight(.light)
...
//                         Spacer()
                    ...
                    VStack {
                        ...
                        Button(action: {
                            ...
                            Image("iconShare")
                                ...
                                .opacity(0.6)
                                .blinking(duration: 3.0)
                                .alert("Your message was sent via push notificaition. \n\nThanks for being a great friend during the tough times. \n\nAnyone can do it on the good days!", isPresented: $showingAlert) {
    ...
    func shareButtonTapped() {
        ...
        for id in selectedFriends {
            for f in friends {
                if f.id == id {
                    RestApi.instance.sendPushNotification(title: "Difficult day?", body: "  \(user.firstName) is checking on you and asking if you want to talk", APNToken: f.APNToken)
