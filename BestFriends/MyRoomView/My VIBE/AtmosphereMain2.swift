...
//                        .confettiCannon(counter: $counter)
    ...
    func shareButtonTapped() {
        ...
        for id in selectedFriends {
            for f in friends {
                if f.id == id {
                    RestApi.instance.sendPushNotification(title: "BestFriends", body: " \(user.firstName) letting you know their day changed! Check to see how you can help!", APNToken: f.APNToken)
