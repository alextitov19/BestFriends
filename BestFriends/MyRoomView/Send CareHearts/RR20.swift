...
//                **************************************
    ...
    func shareButtonTapped() {
        ...
        for id in selectedFriends {
            for f in friends {
                if f.id == id {
                    RestApi.instance.sendPushNotification(title: "BestFriends", body: "  \(user.firstName) said what they like about you in Chat. Long-tap & save to [my Message Vault]", APNToken: f.APNToken)
