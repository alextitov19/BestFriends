...
//                **************************************
    ...
    func shareButtonTapped() {
        ...
        for id in selectedFriends {
            for f in friends {
                if f.id == id {
                    RestApi.instance.sendPushNotification(title: "BestFriends", body: "  \(user.firstName) just wished you luck. Check Chat for message & 'received' CareHearts.", APNToken: f.APNToken)
