                    ...
                    VStack {
                        ...
                        Button(action: {
                            ...
                            Image("iconShare")
                                ...
                                .alert("We are letting them know you are missing them.", isPresented: $showingAlert) {
            ...
            for id in selectedFriends {
                for f in friends {
                    if f.id == id {
                        ...
                        RestApi.instance.createInAppNotification(ian: InAppNotification(user: f.id, sender: user.id, text: "Is missing you! Wish you were here.", createdOn: Int64(Date().timeIntervalSince1970))).then({ response in
