...
//        let arr = [user.id, friend.id]
        ...
        customMessage = "MeetUP Reauest; " + user.firstName + " : " + customMessage;
                    ...
                    VStack {
                        ...
                        Button(action: {
                            ...
                            Image("iconShare")
                                ...
                                .alert("your requet has been sent", isPresented: $showingAlert) {
        ...
        for id in selectedFriends {
            for f in friends {
                if f.id == id {
                    ...
                    RestApi.instance.createInAppNotification(ian: InAppNotification(user: f.id, sender: user.id, text: "just sent you a 'Meetup Coupon' in Chat", createdOn: Int64(Date().timeIntervalSince1970))).then({ response in
