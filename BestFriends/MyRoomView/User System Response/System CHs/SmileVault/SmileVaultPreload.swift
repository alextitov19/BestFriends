//
//  SmileVaultPreload.swift
//  BestFriends
//
//  Created by Social Tech on 11/13/22.
//
...
//                      .frame(height: 80)
              ...
              .shadow(color: Color(#colorLiteral(red: 0.2067186236, green: 0.2054963708, blue: 0.2076624334, alpha: 1)), radius: 10, x: 10, y: 10)
                ...
                NavigationLink(destination:  EmptyView(), label: {
                    SmileVaultCircle (color: ColorManager.purple1, friendName: "View ALL 'nice' messages")
                })
                ...
                NavigationLink(destination: EmptyView(), label: {
                    SmileVaultCircle (color: .red, friendName: "")
                    })
