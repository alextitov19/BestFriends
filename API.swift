...
public struct MessageInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, senderName: String, senderId: String, body: String, creationDate: Int, attachmentPath: String? = nil, stickerNumber: Int? = nil, timestamp: Int? = nil) {
    graphQLMap = ["id": id, "senderName": senderName, "senderID": senderId, "body": body, "creationDate": creationDate, "attachmentPath": attachmentPath, "stickerNumber": stickerNumber, "timestamp": timestamp]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateRoom: GraphQLSelectionSet {
      ...
      public struct Message: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, senderName: String, senderId: String, body: String, creationDate: Int, attachmentPath: String? = nil, stickerNumber: Int? = nil, timestamp: Int? = nil) {
          self.init(snapshot: ["__typename": "Message", "id": id, "senderName": senderName, "senderID": senderId, "body": body, "creationDate": creationDate, "attachmentPath": attachmentPath, "stickerNumber": stickerNumber, "timestamp": timestamp])
        }
