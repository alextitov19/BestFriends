...
public struct CreateMessageInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, senderid: String, body: String, creationDate: String) {
    graphQLMap = ["id": id, "senderid": senderid, "body": body, "creationDate": creationDate]
  }
...
public struct ModelMessageConditionInput: GraphQLMapConvertible {
  ...
  public init(senderid: ModelStringInput? = nil, body: ModelStringInput? = nil, creationDate: ModelStringInput? = nil, and: [ModelMessageConditionInput?]? = nil, or: [ModelMessageConditionInput?]? = nil, not: ModelMessageConditionInput? = nil) {
    graphQLMap = ["senderid": senderid, "body": body, "creationDate": creationDate, "and": and, "or": or, "not": not]
  }
...
public struct UpdateMessageInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, senderid: String? = nil, body: String? = nil, creationDate: String? = nil) {
    graphQLMap = ["id": id, "senderid": senderid, "body": body, "creationDate": creationDate]
  }
...
public struct ModelMessageFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, senderid: ModelStringInput? = nil, body: ModelStringInput? = nil, creationDate: ModelStringInput? = nil, and: [ModelMessageFilterInput?]? = nil, or: [ModelMessageFilterInput?]? = nil, not: ModelMessageFilterInput? = nil) {
    graphQLMap = ["id": id, "senderid": senderid, "body": body, "creationDate": creationDate, "and": and, "or": or, "not": not]
  }
...
public final class CreateMessageMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateMessage: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, senderid: String, body: String, creationDate: String, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Message", "id": id, "senderid": senderid, "body": body, "creationDate": creationDate, "createdAt": createdAt, "updatedAt": updatedAt])
      }
