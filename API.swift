...
public struct CreateNotificationInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, body: String, deviceToken: String, senderId: String, senderName: String) {
    graphQLMap = ["id": id, "body": body, "deviceToken": deviceToken, "senderID": senderId, "senderName": senderName]
  }
...
public struct ModelNotificationConditionInput: GraphQLMapConvertible {
  ...
  public init(body: ModelStringInput? = nil, deviceToken: ModelStringInput? = nil, senderId: ModelStringInput? = nil, senderName: ModelStringInput? = nil, and: [ModelNotificationConditionInput?]? = nil, or: [ModelNotificationConditionInput?]? = nil, not: ModelNotificationConditionInput? = nil) {
    graphQLMap = ["body": body, "deviceToken": deviceToken, "senderID": senderId, "senderName": senderName, "and": and, "or": or, "not": not]
  }
...
public struct UpdateNotificationInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, body: String? = nil, deviceToken: String? = nil, senderId: String? = nil, senderName: String? = nil) {
    graphQLMap = ["id": id, "body": body, "deviceToken": deviceToken, "senderID": senderId, "senderName": senderName]
  }
...
public struct ModelNotificationFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, body: ModelStringInput? = nil, deviceToken: ModelStringInput? = nil, senderId: ModelStringInput? = nil, senderName: ModelStringInput? = nil, and: [ModelNotificationFilterInput?]? = nil, or: [ModelNotificationFilterInput?]? = nil, not: ModelNotificationFilterInput? = nil) {
    graphQLMap = ["id": id, "body": body, "deviceToken": deviceToken, "senderID": senderId, "senderName": senderName, "and": and, "or": or, "not": not]
  }
...
public final class CreateNotificationMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateNotification: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, body: String, deviceToken: String, senderId: String, senderName: String, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Notification", "id": id, "body": body, "deviceToken": deviceToken, "senderID": senderId, "senderName": senderName, "createdAt": createdAt, "updatedAt": updatedAt])
      }
